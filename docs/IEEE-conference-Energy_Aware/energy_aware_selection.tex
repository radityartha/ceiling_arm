...
segmentation, not YOLOE: YOLOE was found unreliable on this simulator's
synthetic imagery in earlier sessions, so YOLOE hardware/detector-realism
validation is left as future work (see Limitations, below).}
