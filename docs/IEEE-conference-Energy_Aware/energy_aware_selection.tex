...
once, a location the end-effector can reach and \textcolor{red}{a representative 8-DOF configuration that reaches it, rail placement included}. This is the sense in which the map is base-aware. Because
...
\textcolor{red}{configuration stays a valid single posture} rather than an average of incompatible base
...
stage decides which arm to use and which 8-DOF configuration to
...
gravity. \textcolor{red}{The rail carries a Coulomb and viscous friction model
