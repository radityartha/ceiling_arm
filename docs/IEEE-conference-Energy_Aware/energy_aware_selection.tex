...
\textbf{E5 (reachable vs.\ unreachable):} \TODO{Pending. Reachable-vs-unreachable
classification accuracy against the GNG capability map, using
\texttt{tomato\_soup\_can} (\texttt{obj\_2}) as the confirmed
unreachable-by-design negative example; see docs/experiment\_plan.md.}
