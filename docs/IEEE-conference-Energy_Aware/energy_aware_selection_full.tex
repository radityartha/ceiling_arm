% ARCHIVED FULL VERSION -- snapshot of energy_aware_selection.tex at commit 30a439c (9 pages, pre-page-trim).
% This file is NOT the actively edited paper; do not sync further edits here.
% See energy_aware_selection.tex for the current (being trimmed toward 6 pages) version.
