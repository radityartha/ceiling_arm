...
\newtcolorbox{sectionpill}{
  ...
  before skip=5.2mm, after skip=2.4mm
}
...
\begin{minipage}[c]{0.085\linewidth}
  \centering
  \bfseries\fontsize{38}{38}\selectfont P-65
\end{minipage}%
\begin{minipage}[c]{0.79\linewidth}
  ...
  {\bfseries\fontsize{40}{46}\selectfont
    Topological Coordination for\\
    a Dual-Gantry Quad-Arm Ceiling Manipulation\par}
  \vspace{2.5mm}
...
\vspace{1.5mm}
{\centering
\includegraphics[height=82mm]{GNG_static3.png}\hspace{5mm}
\includegraphics[height=82mm]{GNG_dynamic3.png}\par}
...
{\centering\includegraphics[trim=95 45 90 45, clip,
   width=\figscale\dimexpr0.84\linewidth\relax]{gng_capability.png}\par}
...
\vspace{1mm}
{\centering\includegraphics[width=\linewidth]{results.pdf}\par}
