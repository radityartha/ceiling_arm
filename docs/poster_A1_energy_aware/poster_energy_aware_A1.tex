...
\begin{minipage}[c]{0.125\linewidth}
  \centering
  % Drop the TMU logo here, e.g.:
  % \includegraphics[width=0.62\linewidth]{tmu_logo.png}
  \begin{tikzpicture}
    \draw[pgrey!45, line width=1.2pt, rounded corners=3mm]
      (0,0) rectangle (3.4,3.4);
    \node[align=center, text=pgrey, font=\fontsize{14}{16}\selectfont]
      at (1.7,1.7) {TMU\\logo};
...
\vspace{1mm}
{\centering\IG{0.92}{gng_capability.png}\par}
...
\vspace{1mm}
{\centering\IG{0.78}{results.pdf}\par}
