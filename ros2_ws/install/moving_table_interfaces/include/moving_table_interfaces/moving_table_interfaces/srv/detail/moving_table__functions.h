...
#ifndef MOVING_TABLE_INTERFACES__SRV__DETAIL__MOVING_TABLE__FUNCTIONS_H_
#define MOVING_TABLE_INTERFACES__SRV__DETAIL__MOVING_TABLE__FUNCTIONS_H_
...
#include "moving_table_interfaces/msg/rosidl_generator_c__visibility_control.h"

#include "moving_table_interfaces/srv/detail/moving_table__struct.h"

/// Initialize srv/MovingTable message.
/**
...
/// Create srv/MovingTable message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moving_table_interfaces__srv__MovingTable_Request__init().
...
/// Destroy srv/MovingTable message.
/**
 * It calls
 * moving_table_interfaces__srv__MovingTable_Request__fini()
...
/// Check for srv/MovingTable message equality.
/**
...
/// Copy a srv/MovingTable message.
/**
...
/// Initialize array of srv/MovingTable messages.
/**
...
/// Finalize array of srv/MovingTable messages.
/**
 * It calls
 * moving_table_interfaces__srv__MovingTable_Request__fini()
...
/// Create array of srv/MovingTable messages.
/**
 * It allocates the memory for the array and calls
 * moving_table_interfaces__srv__MovingTable_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/MovingTable messages.
/**
 * It calls
 * moving_table_interfaces__srv__MovingTable_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MovingTable message array equality.
/**
...
/// Copy an array of srv/MovingTable messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * moving_table_interfaces__srv__MovingTable_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moving_table_interfaces
...
/**
 * It calls
 * moving_table_interfaces__srv__MovingTable_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_moving_table_interfaces
...
/**
 * It allocates the memory for the array and calls
 * moving_table_interfaces__srv__MovingTable_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_moving_table_interfaces
...
/**
 * It calls
 * moving_table_interfaces__srv__MovingTable_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MOVING_TABLE_INTERFACES__SRV__DETAIL__MOVING_TABLE__FUNCTIONS_H_
