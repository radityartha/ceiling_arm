"""Launch the close-curtain demo sequence runner.
...
Only the one-shot close-curtain runner is started by default.
    ...
    ros2 launch workcell_moveit_config close_curtain_demo.launch.py start_table_controller:=true
...
"Table 'table1' is not initialized or available."
"""
...
def generate_launch_description():
    args = [
        ...
        DeclareLaunchArgument("gripper_grip_deg", default_value="40.0",
    ...
    runner = Node(
        ...
        executable="run_close_curtain.py",
        name="close_curtain_runner",
        output="screen",
        parameters=[{
