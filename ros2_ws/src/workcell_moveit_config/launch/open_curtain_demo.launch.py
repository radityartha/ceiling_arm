"""Launch the open-curtain demo sequence runner.
...
Only the one-shot open-curtain runner is started by default.
    ...
    ros2 launch workcell_moveit_config open_curtain_demo.launch.py start_table_controller:=true
...
def generate_launch_description():
    ...
    runner = Node(
        ...
        executable="run_open_curtain.py",
        name="open_curtain_runner",
        output="screen",
        parameters=[{
