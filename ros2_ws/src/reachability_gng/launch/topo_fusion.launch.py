...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # perception provides seg_cloud + /detected_objects + raw labels; start
        # it on Isaac ground truth so seg_cloud is not starved by slow YOLOE.
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(perception),
            launch_arguments={
                'seg_source': LaunchConfiguration('seg_source')}.items()),
