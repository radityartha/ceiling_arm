...
class SequenceRunner(Node):
    ...
    def run_sequence(self) -> bool:
        ...
        steps = [
            ...
            ("8  arm3 approach",           lambda: self.move_joints("arm_3", ARM_JOINTS["arm_3"], [0, -7, -62, 91, -35, 90])),
            ...
            ("10 arm3 move",              lambda: self.move_joints("arm_3", ARM_JOINTS["arm_3"], [90, 0, -57, 90, -27, 91])),
            ("11 table1 -> home",          lambda: self.move_table("table1", 0.0, 0.0)),
            ("12 arm2 approach",           lambda: self.move_joints("arm_2", ARM_JOINTS["arm_2"], [-90, -18, 5, 90, 55, -90])),
            ("12 gripper2 grip",           lambda: self.move_gripper("gripper_2", grip)),
            ("13 table1 -> -90deg",        lambda: self.move_table("table1", 0.0, -90.0)),
